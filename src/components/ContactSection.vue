      ...
      <v-row align="center" justify="center" class="text-right">
        <v-col cols="10">
          <v-row justify="center">
            <v-col cols="12" sm="5">
              <h1 class="font-weight-light display-1">לפרטים נוספים</h1>
              <h3 class="font-weight-light mt-3">
                עבור כל שאלה נוספת שיש ניתן לשלוח גם בוואטסאפ גם בטלפון
              </h3>
              <h3 class="font-weight-light mt-3">
                דרכים ליצירת קשר
              </h3>
